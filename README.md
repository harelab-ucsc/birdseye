...
To install the virtual environment for use with `birdseye`:

```bash
python3 -m venv .venv
. .venv/bin/activate
python3 -m pip install opencv-python matplotlib utm rclpy fiona glob2 tensorflow scikit-learn pupil-apriltags shapely scikit-image pycocotools
```
