...
```
cd existing_repo
git remote add origin https://git.ucsc.edu/hare_lab_group/birdseye.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.ucsc.edu/hare_lab_group/birdseye/-/settings/integrations)
