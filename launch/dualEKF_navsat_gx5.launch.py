...
def generate_launch_description():
    robot_localization_dir = os.path.join(os.path.expanduser('~'), 'ros2_ws')
    ...
    parameters_file_path = os.path.join(parameters_file_dir, 'dualEKF_navsat_gx5.yaml')
    ...
    if os.path.isfile(parameters_file_path):
        ...
        print(f'provided parameters file does not exist: {parameters_file_path}')
        print('exiting')
        sys.exit()
